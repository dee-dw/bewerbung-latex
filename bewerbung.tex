% Copyright 2009-2011,2015-2020,2021 Dominik Wagenfuehr <dominik.wagenfuehr@deesaster.org>
...
\AbsenderLand{Deutschland}           % optional
...
\bwTelefon{Tel.:}{0170 567890}       % optional
...
%\AnschriftLand{DEUTSCHLAND}              % optional
